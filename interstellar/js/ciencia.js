...
async function initHorizonte() {
  ...
  // =====================================================================
   (function(){
	...
	function mostrarError(msg){ throw new Error(msg); }
	...
	*/
	...
	var calidadActual = (contenedor.clientWidth < 700) ? 'baja' : 'alta';
...
`;
	...
	*/
	...
	function reconstruirRTs(){
		...
		var W = contenedor.clientWidth * pr, H = contenedor.clientHeight * pr;
	...
	function aplicarCalidad(nombre){
		...
		uSim.uRes.value.set(contenedor.clientWidth * renderer.getPixelRatio(),
												contenedor.clientHeight * renderer.getPixelRatio());
		uComp.uAspecto.value = contenedor.clientWidth / contenedor.clientHeight;
		reconstruirRTs();
	}
