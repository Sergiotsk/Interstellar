...
- Los IDs son secuenciales en todo el documento (T001…T029). No se reutilizan IDs.
...
**Notas de paralelización**: los marcadores **[P]** expresan independencia de archivos, NO capacidad de equipo. Es un proyecto de un solo estudiante; se recomienda orden secuencial de prioridad (ver Estrategia). No marcar **[P]** dos tareas que editen el mismo archivo (p. ej. T012 y T013, ambas en `css/global.css`).
